...
;; As for population data, this research uses the following census data:
;; - 2011 Census Microdata Individual Safeguarded Sample (Local Authority): England and Wales (https://doi.org/10.5255/UKDA-SN-7682-1)
;; - 2021 Census: Safeguarded Individual Microdata Sample at Grouped Local Authority Level (England and Wales) (https://doi.org/10.5255/UKDA-SN-9155-1)
...
globals [
  ...
  multiple_dep_lsoa_2019_dataset
...
;  mixed_use_building ;; 0=no, 1=yes
  ...
  citycentre_localcentre_suburb ;; 1=Manchester/borough city centres, 2=local centres, 3=suburban neighbourhoods, 4=countryside

  multiple_dep_lsoa_2019 ;; Score. For example, if a Lower-layer Super Output Area (LSOA) has a score of 0.38, this means that 38% of the population is deprived in that area.
...
; Attributes that change in simulation
  ...
  proportion_office
  mixed_use_diversity
  borough_centre_nondep_nei_patch
  local_centre_nondep_nei_patch
]
...
; ##################################################################
turtles-own[
;; 2011 microdata Sample for Greater Manchester has 46,948 Individuals. (2011 census population=2.674 million so roughly 2%)
;; As the main mode of transport information is only collected for work, we extracted 21,430 individuals in employment.
;; 2021 microdata Sample for Greater Manchester has 145,157 Individuals. (2021 census population=2,812,569 so roughly 5%)
;; As the main mode of transport information is only collected for work, we extracted 64,019 individuals in employment.
;; To facilitate speedy simulation, we further randomly extracted 12,804 individuals from above, making it represent roughly 1% of the GM population in employment.
...
;; <Attitude (personal) - Attitude (TPB)>
  ...
  deprived_2021 ;; hh_deprivation. -8=no data. Same codes as 2011.
  age_2021 ;; resident_age_18m. -8=does not apply. Same codes as 2011 except 18=85+.
...
;; <Attitude (personal) - Habit (TIB)>
  ...
  pre_car_2011 ;; can be inferred from prev_region_2011 (car dependency of the previous region lived) or from travel_mode_to_work_2001.

  prev_address_2021 ;; address_1_year_ago. Same codes as 2011.
  prev_region_2021 ;; migrant_region. -8=does not apply, 999999999=migrant origin outside UK, E12000001=North East, E12000002=North West,
       ;; E12000003=Yorkshire and the Humber, E12000004=East Midlands, E12000005=West Midlands, E12000006=East of England,
       ;; E12000007=London, E12000008=South East, E12000009=South West, N99999999=Northern Ireland, S99999999=Scotland, W92000004=Wales
...
;; <Perceived behavioural control (contextual) - Perceived behavioural control (TPB)>
  num_child_2011 ;; dpcfamuk11. Family dependent children. 1=no, 2/4/6=one/two/three with youngest aged 0-9, 3/5/7=one/two/three with youngest aged 10-18
  ...
  activity_limited_2021 ;; disability_4a. Same codes as 2011.
  num_child_2021 ;; family_dependent_children_8m. Same codes as 2011.
  general_health_2021 ;; health_in_general. Same codes as 2011.
  patient_in_house_2021 ;; hh_disabled_4a. Same codes as 2011. -8=does not apply.
  ...
  num_car_own_2021 ;; number_of_cars_6a. -8=does not apply. Same codes as 2011.
  likely_office_desk_job_2021 ;; occupation_27a. 1-2=Managers, 12=Admin, 22=Customer service, 26=Elementary admin and service.
  distance_work_2021 ;; workplace_travel. -8=does not apply. 1=less than 2km, 2=2 to <5km, 3=5 to <10km, 4=10 to <20km,
       ;; 5=20 to <30km, 6=30 to <40km, 7=40 to <60km, 8=60+, 9=works mainly from home;
       ;; 10=works mainly at an offshore insallation/no fixed place/outside UK
...
;; 2011 Census microdata by local authority (safeguarded).
  ...
  ethnicity_2011 ;; ethnicityew. Ethnic group. 1-3=White, 4-5=Mixed/multi eth group, 6-10=Asian/Asian British,
  ...
  workplace_region_2011 ;; wrkplaceew. 1=no fixed place. 2=work mainly at/from home, 3=inside LA area of residence, 4=outsidce LA area but inside GB
...
;; 2021 Census microdata by local authority (safeguarded).
  id_2021 ;; resident_id_m
  la_group_2021 ;; gltla22cd. E68000172=Bolton, E68000173=Bury, E68000174=Manchester,
       ;; E68000175=Oldham, E68000176=Rochdale, E68000177=Salford, E68000178=Stockport,
       ;; E68000179=Tameside, E68000180=Trafford, E68000181=Wigan
  social_grade_2021 ;; approx_social_grade. Same codes as 2011.
  country_birth_2021 ;; country_of_birth_10a. 1=Europe: UK, 2-5=Europe: non-UK, 6-9=Non-Europe.
  ethnicity_2021 ;; ethnic_group_tb_20b. 1-5=Asian, 6-8=Black, 9-12=Mixed, 13-17=White, 18-19=Other.
  deprived_edu_2021 ;; hh_deprivation_education. -8=no data. Same codes as 2011.
  deprived_employ_2021 ;; hh_deprivation_employment. -8=no data. Same codes as 2011.
  deprived_health_2021 ;; hh_deprivation_health. -8=no data. Same codes as 2011.
  deprived_housing_2021 ;; hh_deprivation_housing. -8=no data. Same codes as 2011.
  tenure_2021 ;; hh_tenure. -8=does not apply, 0-1=owned, 2=shared ownership, 3-4=social rented, 5-6=private rented, 9=rent free.
  edu_2021 ;; highest_qualification. -8=does not apply, 0=no qual, 1=level 1(0-4 GCSE), 2=level 2(5+ GCSE), 3=apprenticeship,
      ;; 4=level 3(2+ A levels), 5=level 4(degree), 6=other
  part_full_employ_2021 ;; hours_per_week_worked. -8=does not apply, 0-2=part-time, 3-4=full-time.
  occupation_2021 ;; occupation_27a. 1=Corporate managers and directors ... 26=Elementary administration and service occupations
  place_of_work_2021 ;; place_of_work_ind. -8=does not apply, 1=mainly working at or from home, 2=offshore installation,
      ;; 3=no fixed place, 4=working outside the UK, 5=working in the UK but not working at or from home
  sex_2021 ;; -8=does not apply, 1=female, 2=male.
  travel_mode_to_work_2021 ;; transport_to_workplace_12a. -8=code not required. Same codes as 2011.
      ;; Extra: 12=Not in employment or aged 15 or under (excluded from the working population sample for GM)
  work_from_home_2021 ;; derived from place_of_work_ind. Mainly works at/from home. 0=no, 1=yes.
...
to setup
  ...
  print "running load_gis_data..."
  load_gis_data
  show_citycentre_localcentre_suburb

  if population_data = "2011_census" [
  print "running read_2011_residents_from_csv..."
  read_2011_residents_from_csv
  print "running locate_residents and normalise..."
  locate_residents_2011
  normalise_2011
  ]

  if population_data = "2021_census" [
  print "running read_2021_residents_from_csv..."
  read_2021_residents_from_csv
  print "running locate_residents and normalise..."
  locate_residents_2021
  normalise_2021
  ]

  print "setting built environment variables..."
  setup_nei_patch
  ...
  print "setting resident disease prevalence..."
  set_resident_disease_prevalence

  print "setting transport variables..."
...
to go
  ...
  if (ticks >= 2 and ticks <= 6) and wfh_scenario = "commute_5days_a_week_bau" [
    print "running commute_5days_a_week_bau..."
    commute_5days_a_week_bau
  ]

  if (ticks >= 2 and ticks <= 6) and wfh_scenario = "commute_3days_a_week" [
    print "running commute_3days_a_week..."
    commute_3days_a_week
  ]

  if (ticks >= 2 and ticks <= 6) and wfh_scenario = "commute_1day_a_week_or_less" [
    print "running commute_1day_a_week_or_less..."
    commute_1day_a_week_or_less
  ]

  if (ticks >= 2 and ticks <= 6) and wfh_scenario = "commute_3days_a_week_with_simpler_policy" [
    print "running commute_3days_a_week_with_simpler_policy..."
    commute_3days_a_week_with_simpler_policy
  ]
...
to load_gis_data
  ...
  set multiple_dep_lsoa_2019_dataset gis:load-dataset "data/10feb2023_mul_dep_lsoa_2019.asc"
  ...
  gis:apply-raster multiple_dep_lsoa_2019_dataset multiple_dep_lsoa_2019
...
to show_multiple_dep_lsoa_2019
  ask patches [if multiple_dep_lsoa_2019 = 0 [set pcolor black]]
  ask patches [if multiple_dep_lsoa_2019 > 0 and multiple_dep_lsoa_2019 < 11.3 [set pcolor 8]]
  ask patches [if multiple_dep_lsoa_2019 >= 11.3 and multiple_dep_lsoa_2019 < 20.9 [set pcolor 6]]
  ask patches [if multiple_dep_lsoa_2019 >= 20.9 and multiple_dep_lsoa_2019 < 32 [set pcolor 4]]
  ask patches [if multiple_dep_lsoa_2019 >= 32 and multiple_dep_lsoa_2019 < 46.4 [set pcolor 2]]
  ask patches [if multiple_dep_lsoa_2019 >= 46.4 [set pcolor black]]
end
...
to show_turtles_by_travel_mode
  ask turtles [ifelse current_car_to_work = 1 [set color blue][set color green]]
end
...
to show_turtles_by_switched_mode
  ask turtles [ifelse switched_mode = 1 [set color green][set color blue]]
end

; ##################################################################
; ###### Procedures to read resident turtle properties from a file.
; ##################################################################
to read_2011_residents_from_csv ;; this is mainly for sense-checking.
  file-close-all ; close all open files

  if not file-exists? "data/6may2024_12353_gm_2011_20pc_working_input_no_header.csv" [
    user-message "No file '6may2024_12353_gm_2011_20pc_working_input_no_header.csv' exists!"
    stop
  ]

  file-open "data/6may2024_12353_gm_2011_20pc_working_input_no_header.csv" ; open the file with the turtle data
  ...
  while [ not file-at-end? ] [
    ...
    create-turtles 1 [
      ...
      set size     3
      set shape    "circle"
      set id_2011               item 0 data  ;; 0=column A in excel. 1=column B. ... 29=colum AE.
      set caseno_2011           item 1 data
      ...
      set occupation_2011       item 19 data
      set landlord_type_2011    item 20 data
      set prev_region_2011      item 21 data
      set social_grade_2011     item 22 data
      set sex_2011              item 23 data
      set tenure_2011           item 24 data
      set travel_mode_to_work_2011 item 25 data
      set travel_mode_to_work_2001 item 26 data
      set place_of_work_2011    item 27 data
      set live_near_work_2011   item 28 data
      set workplace_region_2011 item 29 data
    ]
  ]

  ask turtles [ifelse travel_mode_to_work_2011 = 7 or travel_mode_to_work_2011 = 8 [set color blue][set color green]]
  ask turtles [ifelse place_of_work_2011 = 2 [set work_from_home_2011 1][set work_from_home_2011 0]] ;; 0=no, 1=yes
...
to read_2021_residents_from_csv ;; this is mainly for sense-checking.
  file-close-all ; close all open files

  if not file-exists? "data/16jan2024_12804_turtles_2021_gmca_input.csv" [
    user-message "No file '16jan2024_12804_turtles_2021_gmca_input.csv' exists!"
    stop
  ]

  file-open "data/16jan2024_12804_turtles_2021_gmca_input.csv" ; open the file with the turtle data
  ...
  while [ not file-at-end? ] [
    ...
    create-turtles 1 [
      ...
      set size     3
      set shape    "circle"
      set id_2021               item 0 data  ;; 0=column A in excel. 1=column B. ... 29=colum AE.
      set prev_address_2021     item 1 data
      set social_grade_2021     item 2 data
      set country_birth_2021    item 3 data
      set activity_limited_2021 item 4 data
      set ethnicity_2021        item 5 data
      set num_child_2021        item 6 data
      set la_group_2021         item 7 data
      set general_health_2021   item 8 data
      set deprived_2021         item 9 data
      set deprived_edu_2021     item 10 data
      set deprived_employ_2021  item 11 data
      set deprived_health_2021  item 12 data
      set deprived_housing_2021 item 13 data
      set patient_in_house_2021 item 14 data
      set tenure_2021           item 15 data
      set edu_2021              item 16 data
      set part_full_employ_2021 item 17 data
      set prev_region_2021      item 18 data
      set num_car_own_2021      item 19 data
      set occupation_2021       item 20 data
      set place_of_work_2021    item 21 data
      set age_2021              item 22 data
      set sex_2021              item 23 data
      set travel_mode_to_work_2021  item 24 data
      set distance_work_2021    item 25 data
    ]
  ]
;  ask n-of (count turtles * 0.8) turtles [die] ;; Can control the sample size further if one wishees to run the model quicker.

  ask turtles [ifelse travel_mode_to_work_2021 = 7 or travel_mode_to_work_2021 = 8 [set color blue][set color green]]
  ask turtles [ifelse place_of_work_2021 = 1 [set work_from_home_2021 1][set work_from_home_2021 0]]

  ; set current travel mode to work
  ask turtles [ifelse travel_mode_to_work_2021 = 7 or travel_mode_to_work_2021 = 8 [set current_car_to_work 1][set current_car_to_work 0]] ;; 0=non-car, 1=car.

  file-close ; make sure to close the file
end

to locate_residents_2011
  ; Randomly locate the residents by their deprivation scores. Five bins created for the 2019 multiple deprivation by LSOA.
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 ] ]
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 182 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 183 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 ] ]
      ask turtles with [ la_group_2011 = 183 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 183 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 183 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 183 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 183 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 184 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 ] ]
      ask turtles with [ la_group_2011 = 184 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 184 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 184 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 184 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 184 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 185 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 ] ]
      ask turtles with [ la_group_2011 = 185 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 185 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 185 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 185 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 185 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 186 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 ] ]
      ask turtles with [ la_group_2011 = 186 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 186 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 186 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 186 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 186 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 187 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 ] ]
      ask turtles with [ la_group_2011 = 187 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 187 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 187 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 187 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 187 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 188 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 ] ]
      ask turtles with [ la_group_2011 = 188 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 188 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 188 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 188 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 188 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 189 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 ] ]
      ask turtles with [ la_group_2011 = 189 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 189 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 189 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 189 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 189 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 190 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 ] ]
      ask turtles with [ la_group_2011 = 190 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 190 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 190 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 190 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 190 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2011 = 191 and deprived_2011 = "NA" ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 ] ]
      ask turtles with [ la_group_2011 = 191 and deprived_2011 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2011 = 191 and deprived_2011 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2011 = 191 and deprived_2011 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2011 = 191 and deprived_2011 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2011 = 191 and deprived_2011 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]
end

to locate_residents_2021
  ; Randomly locate the residents by their deprivation scores. Five bins created for the 2019 multiple deprivation by LSOA.
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 ] ]
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000172" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 1 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 ] ]
      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000173" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 2 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 ] ]
      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000174" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 3 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 ] ]
      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000175" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 4 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 ] ]
      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000176" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 5 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 ] ]
      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000177" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 6 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 ] ]
      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000178" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 7 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 ] ]
      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000179" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 8 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 ] ]
      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000180" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 9 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]

      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = -8 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 ] ]
      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = 1 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 < 11.317 ] ]
      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = 2 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 11.317 and multiple_dep_lsoa_2019 < 20.889 ] ]
      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = 3 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 20.889 and multiple_dep_lsoa_2019 < 31.995 ] ]
      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = 4 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 31.995 and multiple_dep_lsoa_2019 < 46.350 ] ]
      ask turtles with [ la_group_2021 = "E68000181" and deprived_2021 = 5 ] [ move-to one-of patches with
        [ resi_height_sep2022 > 0 and borough = 10 and multiple_dep_lsoa_2019 >= 46.350 and multiple_dep_lsoa_2019 < 79.300 ] ]
end
...
to normalise_2011
  ask turtles with [deprived_2011 = "NA"][set deprived_2011 0]
...
; deprived_2011 ;; Household deprivation. 0=no data. 1=not deprived. 2=deprived in 1 dimension, 3=deprived in 2 dimensions,
       ;; 4=deprived in 3 dimensions, 5=deprived in 4 dimensions
  ask turtles with [deprived_2011 = 1][set deprived_2011_pc 40]
  ask turtles with [deprived_2011 = 2][set deprived_2011_pc 55]
  ask turtles with [deprived_2011 = 3][set deprived_2011_pc 70]
  ask turtles with [deprived_2011 = 4][set deprived_2011_pc 85]
...
; travel_mode_to_work_2001 ;; transport_2001. Method of travel to work (2001). 1=work mainly at/from home, 2=underground/metro/light rail/tram, 3=train
       ;; 4=bus/minibus/coach, 5=taxi, 6=motorcycle/scooter/moped, 7=driving car/van, 8=passenger in car/van, 9=bicycle
       ;; 10=on foot, 11=other
  ask turtles [ifelse travel_mode_to_work_2001 = 7 or travel_mode_to_work_2001 = 8 [set pre_car_2011_pc 100][set pre_car_2011_pc 50]]
...
; Turn into ordinal based on the likely level of responsibility to provide car ride.
  ...
  ask turtles with [num_child_2011 = 3][set num_child_2011_pc 30]
  ask turtles with [num_child_2011 = 5][set num_child_2011_pc 40]
  ask turtles with [num_child_2011 = 7][set num_child_2011_pc 50]
  ask turtles with [num_child_2011 = 2][set num_child_2011_pc 60]
  ask turtles with [num_child_2011 = 4][set num_child_2011_pc 70]
  ask turtles with [num_child_2011 = 6][set num_child_2011_pc 80]
  ask turtles with [num_child_2011 = -9][set num_child_2011_pc 0]

; general_health_2011 ;; health. General health. 1=very good, 2=good, 3=fair, 4=bad, 5=very bad
  ask turtles with [general_health_2011 = 5][set general_health_2011_pc 20]
  ask turtles with [general_health_2011 = 4][set general_health_2011_pc 40]
  ask turtles with [general_health_2011 = 3][set general_health_2011_pc 60]
  ask turtles with [general_health_2011 = 2][set general_health_2011_pc 80]
  ask turtles with [general_health_2011 = 1][set general_health_2011_pc 100]

; activity_limited_2011 ;; disability. Long-term health problem. Day-to-day activities 1=limited a lot, 2=limited a little, 3=not limited
  ask turtles with [activity_limited_2011 = 3][set activity_limited_2011_pc 20]
  ask turtles with [activity_limited_2011 = 2][set activity_limited_2011_pc 60]
  ask turtles with [activity_limited_2011 = 1][set activity_limited_2011_pc 100]

; patient_in_house_2011 ;; illhuk11g. ilIndividuals in household with long-standing illness/disability. 0=no, 1=1, 2=2+.
  ask turtles with [patient_in_house_2011 = 0][set patient_in_house_2011_pc 50]
  ask turtles with [patient_in_house_2011 = 1][set patient_in_house_2011_pc 75]
...
; likely_office_desk_job_2011 ;; iscog 11-14=Managers; 24-25=Business/admin/ICT professionals; 33=Business/admin associate professionals
       ;; 35=Info and communication technicians; 41-44=Clerks
       ;; https://en.wikipedia.org/wiki/International_Standard_Classification_of_Occupations
  ask turtles [ifelse occupation_2011 = 11 or occupation_2011 = 12
    or occupation_2011 = 13 or occupation_2011 = 14
    or occupation_2011 = 24 or occupation_2011 = 25
    or occupation_2011 = 33 or occupation_2011 = 35
    or occupation_2011 = 41 or occupation_2011 = 42
    or occupation_2011 = 43 or occupation_2011 = 44
    [set likely_office_desk_job_2011 1] ;; yes
    [set likely_office_desk_job_2011 0] ;; no
  ]
...
to calculate_density_twokm_radius
  ask turtles [set density_twokm_radius mean [building_height] of nei_patch]
  ask turtles [
    set density_twokm_radius_pc density_twokm_radius * 30
    ask turtles with [density_twokm_radius_pc > 100] [set density_twokm_radius_pc 100]
    ;; Normalise. Max value in Manchester city centre. Even if other areas become more dense,
    ;; it is unlikely to become more dense than the max density area of Manchester city centre.
  ]
end
...
;; Attitude (TPB)
  ...
  if (ticks >= 2 and ticks <= 12) and wfh_scenario = "commute_3days_a_week_with_simpler_policy" [
  print "applying the impact of commute_3days_a_week_with_simpler_policy on bus/tram/cycle hire reliability, freq_connectivity, safety (also for walking/cycling environment), and affordability..."
  ...
  ask turtles with [current_car_to_work = 1][ ;; will take longer but can ask all turtles for the sake of calculating these values for current non-car users as well.
    ...
    set p_deprived_2011 random deprived_2011_pc ;; lower the deprivation level, lower the likelihood to switch from car to non-car.
    ...
    set p_safety random safety_pc
  ]

  print "running switch_travel_mode for subjective norm (social)..."
  ask turtles with [current_car_to_work = 1][
    set nei_non_car_pc count nei_turtle with [current_car_to_work = 0] / count nei_turtle * 100]
  ask turtles with [current_car_to_work = 1][
    set p_nei_non_car random nei_non_car_pc]
...
;; distance_work_2011 ;; aggdtwpew11g. Distance travelled to work. 1=less than 2km, 2=2 to <5km, 3=5 to <10km, 4=10 to <20km,
  ...
  ask turtles with [current_car_to_work = 1][
    ...
    if work_from_home_2011 = 0 [set p_likely_work_from_home likely_office_desk_job_2011_pc];; if not work from home from the census, set the likelihood based on likely_office_desk_job
  ]

  if (ticks >= 2 and ticks <= 12) and wfh_scenario = "commute_3days_a_week" or wfh_scenario = "commute_3days_a_week_with_simpler_policy" [
  print "applying the impact of commute_3days_a_week or commute_3days_a_week_with_simpler_policy on p_likely_work_from_home..."
    ask turtles with [current_car_to_work = 1 and likely_office_desk_job_2011 = 1][
      set likely_office_desk_job_2011_pc likely_office_desk_job_2011_pc + 5 ;; culture of commuting 3 days a week is likely to increae the turtle's likelihood of work from home.
    ]
  ]

  if (ticks >= 2 and ticks <= 12) and wfh_scenario = "commute_1day_a_week_or_less" [
  print "applying the impact of commute_1day_a_week_of_less on p_likely_work_from_home..."
    ask turtles with [current_car_to_work = 1 and likely_office_desk_job_2011 = 1][
      set likely_office_desk_job_2011_pc likely_office_desk_job_2011_pc + 10 ;; culture of commuting 1 day a week or less is likely to increae the turtle's likelihood of work from home.
    ]
  ]

  ask turtles with [likely_office_desk_job_2011_pc > 100] [set likely_office_desk_job_2011_pc 100 set distance_work_2011 1]

  print "running switch_travel_mode for perceived behavioural control (contextual)_3/4..."
  ask turtles with [current_car_to_work = 1 and deprived_2011 = 1] [set p_affordability random-float (affordability_pc * 0.5)] ;; For non-deprived, affects less.
  ask turtles with [current_car_to_work = 1 and deprived_2011 > 1] [set p_affordability random-float affordability_pc]
...
;; 0.75 as moderately important and 0.5 as less important.
  ...
  + p_freq_connectivity + p_safety) / (0.5 + 1 + 0.75 + 1 + 1 + 1) / 100
    ...
    set pbc_2011 (p_num_child_2011 + p_general_health_2011 + p_activity_limited_2011
        ...
        + p_likely_work_from_home + p_affordability + density_twokm_radius_pc * 0.75
        + proximity_twokm_radius_pc * 0.75 + mixed_use_twokm_radius_pc * 0.75
  ...
  ask turtles with [current_car_to_work = 1 and behavior_2011 > 0.32][
    print (word " ticks: " ticks " turtle that switched from car to non-car: " who)
  ]

  file-close
    file-open "switched_turtle_attributes.txt"
    ask turtles with [current_car_to_work = 1 and behavior_2011 > 0.32]
      [file-print (word ticks " " who " " id_2011 " " la_group_2011 " " xcor " " ycor " " age_2011_pc " " p_age_2011 " "
        deprived_2011_pc " " p_deprived_2011 " " pre_car_2011_pc " " p_pre_car_2011 " "
        reliability_pc " " p_reliability " " freq_connectivity_pc " " p_freq_connectivity " "
        safety_pc " " p_safety " " nei_non_car_pc " " p_nei_non_car " "
        num_child_2011_pc " " p_num_child_2011 " " general_health_2011_pc " " p_general_health_2011 " "
        activity_limited_2011_pc " " p_activity_limited_2011 " " patient_in_house_2011_pc " " p_patient_in_house_2011 " "
        likely_work_from_home_pc " " p_likely_work_from_home " " affordability_pc " " p_affordability " "
        density_twokm_radius " " density_twokm_radius_pc " " proximity_twokm_radius " " proximity_twokm_radius_pc " "
        mixed_use_twokm_radius " " mixed_use_twokm_radius_pc " " pm10_twokm_radius_pc " " p_pm10_twokm_radius " "
        attitude_2011 " " sn_2011 " " pbc_2011 " " behavior_2011)]
    file-close

  ask turtles with [current_car_to_work = 1 and behavior_2011 > 0.32][
    set color green
    set current_car_to_work 0
    set switched_mode 1
...
;; 1. In Manchester/Trafford city centre, decrease retail/office by 5% and replace with resi.
  print "running commute_3days_a_week for land/building use change..."
  let num_patches_retail_citycentre count patches with [borough = 3 or borough = 9] with [retail_height > 0 and citycentre_localcentre_suburb = 1]
  ask n-of (num_patches_retail_citycentre * 0.05) patches with [borough = 3 or borough = 9] with [retail_height > 0 and citycentre_localcentre_suburb = 1][
    set resi_height resi_height + retail_height
    set retail_height 0
  ]
  let num_patches_office_citycentre count patches with [borough = 3 or borough = 9] with [office_height > 0 and citycentre_localcentre_suburb = 1]
  ask n-of (num_patches_office_citycentre * 0.05) patches with [borough = 3 or borough = 9] with [office_height > 0 and citycentre_localcentre_suburb = 1][
    set resi_height resi_height + office_height
    set office_height 0
  ]

;; 2. In non-deprived borough/local centres, increase resi/retail/office in 5% of the patches
  let num_patches_borough_centre_nondep count patches with [citycentre_localcentre_suburb = 1 or citycentre_localcentre_suburb = 2] with [multiple_dep_lsoa_2019 < 20.889]
  ask n-of (num_patches_borough_centre_nondep * 0.05) patches with [citycentre_localcentre_suburb = 1 or citycentre_localcentre_suburb = 2] with [multiple_dep_lsoa_2019 < 20.889][
    set resi_height 8]
  ask n-of (num_patches_borough_centre_nondep * 0.05) patches with [citycentre_localcentre_suburb = 1 or citycentre_localcentre_suburb = 2] with [multiple_dep_lsoa_2019 < 20.889][
    set retail_height 8]
  ask n-of (num_patches_borough_centre_nondep * 0.05) patches with [citycentre_localcentre_suburb = 1 or citycentre_localcentre_suburb = 2] with [multiple_dep_lsoa_2019 < 20.889][
...
;; Population movement
;; 1. Move 5% of non-deprived residents aged 30+ in Manchester/Trafford city centres move to non-deprived borough/local centres.
  let num_turtles_nondep_citycentre_30plus count (turtles-on patches with [borough = 3 or borough = 9]) with [deprived_2011 = 1 and age_2011_pc > 30]
  ask n-of (num_turtles_nondep_citycentre_30plus * 0.05) (turtles-on patches with [borough = 3 or borough = 9]) with [deprived_2011 = 1 and age_2011_pc > 30]
  [ move-to one-of patches with [citycentre_localcentre_suburb = 1 or citycentre_localcentre_suburb = 2] with [resi_height > 0 and multiple_dep_lsoa_2019 < 20.889]
  ]

  print "running commute_3days_a_week for population movement 2/2..."
;; 2. Move 5% of non-deprived residents aged 18-30 in local centres, suburbs and less built areas move to non-deprived city/borough centre.
  let num_turtles_nondep_localcentre_18_30 count (turtles-on patches with [citycentre_localcentre_suburb = 2 or citycentre_localcentre_suburb = 3 or citycentre_localcentre_suburb = 4]) with [deprived_2011 = 1 and age_2011_pc >= 18 and age_2011_pc <= 30]
  ask n-of (num_turtles_nondep_localcentre_18_30 * 0.05) (turtles-on patches with [citycentre_localcentre_suburb = 2 or citycentre_localcentre_suburb = 3 or citycentre_localcentre_suburb = 4]) with [deprived_2011 = 1 and age_2011_pc >= 18 and age_2011_pc <= 30]
  [ move-to one-of patches with [citycentre_localcentre_suburb = 1 and resi_height > 0 and multiple_dep_lsoa_2019 < 20.889]
  ]
end
...
to commute_3days_a_week_with_simpler_policy
commute_3days_a_week ;; the policy effect is incorporated in switch_travel_mode
end
...
; ##################################################################
to export_resi_height_asc
    file-close
    file-delete "resi_height.asc"
    file-open "resi_height.asc"
    ...
    [ set the-row []
      ...
      foreach sort-on [pxcor] the-row [ z -> ask z  [file-write resi_height] ]
      wait 0.001
      file-print "   "
      set pri (pri - 1)]
      wait 0.001
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles > 0 [plot count turtles with [current_car_to_work = 1] / count turtles * 100]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [deprived_2011 > 1] > 0 [plot mean [density_twokm_radius_pc] of turtles with [deprived_2011 > 1]]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [deprived_2011 > 1] > 0 [plot mean [proximity_twokm_radius_pc] of turtles with [deprived_2011 > 1]]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [deprived_2011 > 1] > 0 [plot mean [mixed_use_twokm_radius_pc] of turtles with [deprived_2011 > 1]]"
...
188
411
Show turtles by green (yes/positive) and blue (no/negative)
11
0.0
1
...
wfh_scenario
wfh_scenario
"commute_5days_a_week_bau" "commute_3days_a_week" "commute_1day_a_week_or_less" "commute_3days_a_week_with_simpler_policy"
3
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [deprived_2011 > 1] > 0 [plot mean [p_likely_work_from_home] of turtles with [deprived_2011 > 1]]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [ deprived_2011 != 1 ] > 0 [plot (count turtles with [ diabetes_2022 = 1 and deprived_2011 != 1 ] / count turtles with [ deprived_2011 != 1 ]) * 100]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles > 0 [plot (count turtles with [ diabetes_2022 = 1] / count turtles) * 100]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [ deprived_2011 != 1 ] > 0 [plot (count turtles with [ current_car_to_work = 1 and deprived_2011 != 1 ] / count turtles with [ deprived_2011 != 1 ]) * 100]"
...
102
mode_share_car_dep
count turtles with [ current_car_to_work = 1 and deprived_2011 != 1 ] / count turtles with [ deprived_2011 != 1 ] * 100
2
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if count turtles with [deprived_2011 > 1] > 0 [plot mean [p_affordability] of turtles with [deprived_2011 > 1]]"
